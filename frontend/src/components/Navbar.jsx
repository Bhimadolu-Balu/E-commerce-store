...
const Navbar = () => {
	...
	return (
		<header className='fixed top-0 left-0 w-full bg-[#8D0B41] bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-emerald-800'>
			<div className='container mx-auto px-4 py-3'>
				<div className='flex flex-wrap justify-between items-center'>
					...
					<nav className='flex flex-wrap items-center gap-4'>
						...
						{isAdmin && (
							<Link
								className='bg-[rgba(221,168,83,0.9)] hover:bg-[rgba(221,168,83,0.8)] text-white px-3 py-1 rounded-md font-medium
